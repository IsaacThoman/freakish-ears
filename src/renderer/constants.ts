...
export const DYNAMIC_PROPORTIONAL_P_STORAGE_KEY = 'freakish-ears-dynamic-proportional-p';
export const PID_PROPORTIONAL_GAIN_STORAGE_KEY = 'freakish-ears-pid-proportional-gain';
export const PID_INTEGRAL_GAIN_STORAGE_KEY = 'freakish-ears-pid-integral-gain';
export const PID_DERIVATIVE_GAIN_STORAGE_KEY = 'freakish-ears-pid-derivative-gain';
export const DAMPED_REFIT_BLEND_STORAGE_KEY = 'freakish-ears-damped-refit-blend';
export const MOMENTUM_BLEND_STORAGE_KEY = 'freakish-ears-momentum-blend';
export const MOMENTUM_DECAY_STORAGE_KEY = 'freakish-ears-momentum-decay';
...
export const AUTOMATION_TOLERANCE_MAX_ACCEPTABLE_ERROR_WIDTH_STORAGE_KEY = 'freakish-ears-automation-tolerance-max-acceptable-error-width-hz';
...
export const DEFAULT_APO_MAX_FILTERS = 1;
export const DEFAULT_GRAPHIC_APO_MAX_FILTERS = 16;
export const MAX_PARAMETRIC_APO_FILTERS = 24;
...
export const DEFAULT_AUTOMATION_ALGORITHM = 'pid';
export const DEFAULT_AUTOMATION_DELAY_SECONDS = 1;
export const DEFAULT_PROPORTIONAL_P = 0.1;
export const DEFAULT_DYNAMIC_PROPORTIONAL_P = false;
export const DEFAULT_PID_PROPORTIONAL_GAIN = 0.22;
export const DEFAULT_PID_INTEGRAL_GAIN = 0.01;
export const DEFAULT_PID_DERIVATIVE_GAIN = 0.04;
export const DEFAULT_DAMPED_REFIT_BLEND = 0.35;
export const DEFAULT_MOMENTUM_BLEND = 0.2;
export const DEFAULT_MOMENTUM_DECAY = 0.75;
export const DEFAULT_AUTOMATION_STOP_ON_TOLERANCE = false;
export const DEFAULT_AUTOMATION_TOLERANCE_MAX_ACCEPTABLE_ERROR_WIDTH_HZ = 0;
